...
public class BombDefuserMulti : NetworkBehaviour {
    ...
    public void DiffuseBomb()
    {
        ...
        GameObject.Find("GameController").GetComponent<GameControllerBSMulti>().localplayerobj.GetComponent<GameStateChecker>().initiateBombDefuse();
        ...
        //GameObject.Find("GameController").GetComponent<GameControllerBSMulti>().localplayerobj.GetComponent<GameStateChecker>() = true;
