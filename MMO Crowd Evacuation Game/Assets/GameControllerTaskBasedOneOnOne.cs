...
public class GameControllerTaskBasedOneOnOne : NetworkBehaviour {
    ...
    void FixedUpdate()
    {
            ...
            if (gmc.ctypeid == "2")
            {
            if (GameObject.Find("TeamCounter") != null)
            {
            ...
            if (GameObject.FindGameObjectsWithTag("prize").Length == 0 && !end)
            {
            ...
            if (gmc.ctypeid == "1")
                {
                    ...
                    if (agent.GetComponent<PlayerController1>().localplayer)
                    {
                        ...
                        agent.GetComponent<PlayerController1>().scoretype = "Prizes Collected";
                    }
                    //data tracker///////////////////////////
